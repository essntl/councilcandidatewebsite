...
export default function AboutPage() {
    return (
        <main>
            <section className="bg-[#18577f] text-white">
            ...
            <section className="mx-auto grid w-full max-w-[1240px] grid-cols-1 gap-[54px] px-[19px] py-[78px] md:grid-cols-[0.82fr_1fr] md:gap-[9%] md:px-6 md:py-[120px] lg:px-9">
                <div className="relative min-h-[475px] overflow-hidden rounded-[28px] md:min-h-[620px]">
                    ...
                    <div className="pointer-events-none absolute inset-0 rounded-[inherit] bg-linear-to-b from-transparent from-70% to-[#0e4365]/40" />
                </div>
                <div className="md:pt-7">
                    <h2 className="mb-8 text-[clamp(40px,4.8vw,66px)] leading-[1.06] font-semibold tracking-[-0.045em]">
                        Jeg heter Mykhailo.
                    </h2>
                    <p className="mb-[30px] max-w-[580px] text-xl leading-[1.55] text-[#142b3d]">
                    ...
                    <p className="mb-[23px] max-w-[580px] text-sm leading-[1.8] text-[#60778a]">
            ...
            <section className="rounded-t-[30px] bg-[#e5f1f8] py-[74px] pb-[76px] md:rounded-t-[48px] md:py-[95px] md:pb-[105px]">
                <div className="mx-auto w-full max-w-[1240px] px-[19px] md:px-6 lg:px-9">
                    <p className="mb-6 flex items-center gap-3 text-[10px] font-bold tracking-[0.15em] text-[#60778a] uppercase before:h-px before:w-7 before:bg-current">
                        Slik vil jeg lede
                    </p>
                    <div className="grid grid-cols-1 gap-[18px] md:grid-cols-3">
                        <article className="min-h-[220px] rounded-[26px] bg-white/50 p-[27px] md:min-h-[245px]">
                            ...
                            <p className="m-0 max-w-[270px] text-[13px] leading-[1.6] text-[#60778a]">
            ...
            <section className="mx-auto grid w-full max-w-[1240px] grid-cols-1 items-end gap-8 px-[19px] py-[76px] md:grid-cols-[1fr_auto] md:px-6 md:py-[110px] lg:px-9">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="mt-1 text-[10px] text-[#60778a]">Kandidat til elevrådsleder</span>
                </div>
                <Link
                    className="inline-flex min-h-12 w-fit items-center justify-center gap-[18px] rounded-full bg-[#18577f] px-[21px] text-xs font-bold text-white transition hover:-translate-y-0.5"
                    href="/kontakt"
                >
            ...
            <section className="bg-[#18577f] text-white">
                <div className="mx-auto grid min-h-[350px] w-full max-w-[1240px] grid-cols-1 content-center items-center gap-7 px-[19px] md:min-h-[290px] md:grid-cols-[0.55fr_1.5fr_auto] md:px-6 lg:px-9">
                    ...
                    <Link
                        className="inline-flex min-h-12 w-fit items-center justify-center gap-[18px] rounded-full bg-white px-[21px] text-xs font-bold text-[#142b3d] transition hover:-translate-y-0.5 hover:bg-[#e5f1f8]"
                        href="/#stem"
                    >
