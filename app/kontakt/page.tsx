    ...
    <main>
      <section className="mx-auto grid min-h-[480px] w-full max-w-[1240px] grid-cols-1 items-start gap-[45px] px-[19px] py-[72px] md:grid-cols-[1.2fr_0.55fr] md:items-end md:gap-[12%] md:px-6 md:py-[82px] lg:px-9">
        <div>
          ...
          <p className="mt-7 max-w-[590px] text-[15px] leading-[1.7] text-[#746a7d]">
        ...
        <div className="rounded-[26px] bg-violet-200 p-7">
          <p className="mb-[18px] text-[9px] font-bold tracking-[0.15em] text-[#746a7d] uppercase">Direkte kontakt</p>
          <a className="mb-[22px] inline-block border-b border-[#241533] pb-[3px] text-lg font-semibold" href="mailto:mykhailo@elevraad.no">mykhailo@elevraad.no</a>
          <p className="m-0 text-xs leading-[1.65] text-[#746a7d]">Du finner meg også på skolen. Kom gjerne bort og si hei.</p>
        </div>
      </section>

      <section className="rounded-t-[30px] bg-violet-200 py-[74px] pb-[76px] md:rounded-t-[48px] md:py-[100px] md:pb-[115px]">
        <div className="mx-auto grid w-full max-w-[1240px] grid-cols-1 gap-[50px] px-[19px] md:grid-cols-[0.62fr_1.38fr] md:gap-[11%] md:px-6 lg:px-9">
          ...
          <form className="flex flex-col gap-[27px]">
            ...
            <label className="flex flex-col">
              ...
              <textarea
                className="min-h-[150px] resize-y rounded-2xl border border-transparent bg-white/60 px-4 py-3.5 outline-none transition focus:border-[#6f00ff] focus:bg-white"
                name="message"
            ...
            <div className="flex flex-col items-start justify-between gap-[22px] md:flex-row md:items-center">
              ...
              <button className="inline-flex min-h-12 items-center justify-center gap-[18px] rounded-full border-0 bg-[#6f00ff] px-[21px] text-xs font-bold text-white transition hover:-translate-y-0.5" type="submit">
      ...
      <section className="mx-auto w-full max-w-[1240px] px-[19px] py-[76px] md:px-6 md:py-[110px] lg:px-9">
        <p className="mb-6 flex items-center gap-3 text-[10px] font-bold tracking-[0.15em] text-[#746a7d] uppercase before:h-px before:w-7 before:bg-current">Elevrådsvalget 2026</p>
