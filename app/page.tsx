        ...
        <main>
            <section className="relative min-h-[800px] overflow-hidden text-white md:min-h-[calc(100svh-76px)]">
                ...
                <div
                    ...
                    aria-hidden="true"
                />
                <div className="relative z-10 mx-auto block min-h-[800px] w-full max-w-[1240px] px-[19px] pt-16 md:grid md:min-h-[calc(100svh-76px)] md:grid-cols-[1.1fr_0.75fr] md:items-center md:gap-[35px] md:px-6 md:py-[54px] lg:grid-cols-[1.15fr_0.72fr] lg:gap-[clamp(30px,6vw,90px)] lg:px-9">
                    <div className="relative z-10 max-w-[700px]">
                        ...
                        <h1 className="m-0 text-[48px] leading-[0.98] font-semibold tracking-[-0.05em] md:text-[clamp(52px,6.6vw,94px)]">
                            En tydelig stemme.
                            <span className="block text-[#b9e1f8]">Et sterkere fellesskap.</span>
                        </h1>
                        ...
                        <div className="flex items-center gap-5 md:gap-7">
                            <a
                                className="inline-flex min-h-12 items-center justify-center gap-[18px] rounded-md bg-white px-[21px] text-xs font-bold text-[#142b3d] transition hover:-translate-y-0.5 hover:bg-[#e5f1f8]"
                                href="#stem"
                            >
                    ...
                    <div
                        className="absolute right-[19px] bottom-0 h-[370px] w-[72%] overflow-hidden rounded-2xl md:relative md:right-auto md:bottom-auto md:h-[min(66vh,610px)] md:min-h-[430px] md:w-full lg:min-h-[480px]"
                        aria-label="Portrett av Mykhailo Huseinov"
                    >
                        <div className="absolute inset-0 bg-[url('/hero.jpg')] bg-cover bg-top saturate-[0.62] contrast-[1.03] after:absolute after:inset-0 after:bg-linear-to-b after:from-transparent after:from-65% after:to-[#0c3956]/60" />
                    </div>
                </div>
            </section>
            ...
            <section className="mx-auto w-full max-w-[1240px] px-[19px] py-[76px] md:px-6 md:py-[110px] lg:px-9">
                ...
                <div className="grid gap-7 md:grid-cols-[1.25fr_0.65fr] md:gap-[11%]">
                    ...
                    <div className="flex flex-col items-start justify-between">
                        <p className="my-1 max-w-xl text-[15px] leading-[1.75] text-[#60778a] md:mb-8">
            ...
            <section
                className="rounded-t-[30px] bg-[#e5f1f8] py-[74px] md:rounded-t-[48px] md:py-[100px] md:pb-[110px]"
                id="hjertesaker"
            >
                <div className="mx-auto w-full max-w-[1240px] px-[19px] md:px-6 lg:px-9">
                    <div className="mb-[38px] flex items-start justify-between md:mb-[52px] md:items-end">
                        <div>
                            <p className="mb-5 flex items-center gap-3 text-[10px] font-bold tracking-[0.15em] text-[#60778a] uppercase before:h-px before:w-7 before:bg-current">
                        ...
                        <p className="hidden text-right text-[10px] leading-[1.6] tracking-[0.08em] text-[#60778a] uppercase md:block">
                            Konkrete mål. Åpen prosess.
                            <br />
                            Resultater vi kan se.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-[18px] md:grid-cols-3">
                        {priorities.map(priority => (
                            ...
                            >
                                ...
                                <p className="m-0 text-[13px] leading-[1.65] text-[#60778a]">{priority.text}</p>
                            </article>
                        ))}
                    </div>
                </div>
